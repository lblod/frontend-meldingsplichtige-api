...
export default class FormsEditRoute extends Route {
  ...
  setupController(controller, model){
    ...
    const sourceGraph = new rdflib.NamedNode(`http://data.lblod.info/${model.id}`);
    const metaGraph = new rdflib.NamedNode("http://data.lblod.info/metagraph");
    controller.graphs = { formGraph, sourceGraph, metaGraph  };

    //TODO: how do i get this
    controller.sourceNode = new rdflib.NamedNode("http://data.lblod.info/vocabularies/ext/besluitenlijsten/208ee6e0-28b1-11ea-972c-8915ff690069");
